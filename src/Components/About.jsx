    ...
    <div>
      ...
      <div className="faqs">
        ...
        <FAQsection
          ...
          content="Watch Netflix on your smartphone, tablet, Smart TV, laptop, or
            streaming device, all for one fixed monthly fee. Plans range from ₹
            199 to ₹ 799 a month. No extra costs, no contracts."
        />
        <FAQsection
          heading="Where can I watch?"
          content="Watch anywhere, anytime, on an unlimited number of devices. Sign in
            ...
            can also download your favourite shows with the iOS, Android, or
        ...
        <FAQsection
          ...
          content="Netflix is flexible. There are no annoying contracts and no
        ...
        <FAQsection
          ...
          content="Netflix has an extensive library of feature films, documentaries, TV
            shows, anime, award-winning Netflix originals, and more. Watch as
            much as you want, anytime you want."
        />
        <FAQsection
          heading="Is Netflix good for kids?"
          content="The Netflix Kids experience is included in your membership to give
